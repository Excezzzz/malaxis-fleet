...
if ($lang -eq "en") {
    ...
    $T_COMPOSE_MISSING      = "Docker Compose was not found! Install Docker Desktop from the official site: https://www.docker.com/products/docker-desktop/ , then re-run this script."
    ...
    $T_COMPOSE_MISSING      = "Docker Compose не найден! Установите Docker Desktop с официального сайта: https://www.docker.com/products/docker-desktop/ , затем запустите скрипт заново."
