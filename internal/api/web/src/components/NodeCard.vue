    ...
    <div class="mt-auto pt-4">
      ...
      <div class="mt-3 space-y-2">
        ...
        <template v-if="canManage">
            ...
            <div class="flex flex-wrap gap-2">
                <button v-if="canViewNodeLogs" @click="openLogs" class="flex-1 min-w-[100px] flex items-center justify-center space-x-2 bg-white/5 hover:bg-white/10 border border-white/10 text-zinc-400 hover:text-white font-semibold py-2 px-4 min-h-[40px] rounded-xl transition-colors">
