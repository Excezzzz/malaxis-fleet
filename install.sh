...
if [[ ! -f .env ]]; then
  ...
  read -r -s -p "Master admin username [admin]: " ADMIN_USER; echo
  ADMIN_USER="${ADMIN_USER:-admin}"
  read -r -s -p "Master admin password: " ADMIN_PASS; echo
...
echo -e "\n${CYAN}------------------------------------------------${NC}"
echo -e "Dashboard: https://${DASH_DOMAIN:-<your-domain>}"
echo -e "Logs:      docker logs -f fleet-master"
echo -e "${CYAN}------------------------------------------------${NC}\n"
